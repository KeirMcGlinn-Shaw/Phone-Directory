...
//Tests the efficiency of my ArrayDirectory implementation
public class ArrayDirectoryStopWatchTest implements Test {
	// StopWatch class field which will be used to test timings
	private StopWatch stopWatch = new StopWatch();
	
	public ArrayDirectoryStopWatchTest() throws FileNotFoundException {
		testPrintDirectory();
		System.out.println("\n\n");
		testAddEntry();
		System.out.println("\n\n");
	...
	//Test the efficiency of ArrayDirectory.addEntry()
	public void testAddEntry() {
		ArrayDirectory directory; //ArrayDirectory object that will be used for the tests
		...
		directory = new ArrayDirectory(); //Instantiates the ArrayDirectory
		Scanner inFile;
		try {
		...
		// Calls methods to return the average, best and worst times recorded by testRemoveEntry and store them in variables
		avarage = getAvarageTime(timings);
		best = getBestTime(timings);
		worst = getWorstTime(timings);
		
		// Print the average, best and worst timings
		System.out.format("Timings for ArrayDirectory addEntry method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
	...
	public void testRemoveEntryByTelExt() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ArrayDirectory removeEntry using telExt to search method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testRemoveEntryByName() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ArrayDirectory removeEntry using name to search method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testChangeNumber() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ArrayDirectory changeNumber method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testLookupTelExtNum() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ArrayDirectory lookupExtNum method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	// Main method, which instantiates ArrayDirectoryStopWatchTest
	public static void main(String[] args) throws FileNotFoundException {
		new ArrayDirectoryStopWatchTest();
	}
