...
public class ListDirectoryStopWatchTest implements Test{

	private StopWatch stopWatch = new StopWatch();
	
	public ListDirectoryStopWatchTest() {
		testPrintDirectory();
		System.out.println("\n\n");
		testAddEntry();
		System.out.println("\n\n");
	...
	public void testAddEntry() {
		...
		System.out.format("Timings for ListDirectory addEntry method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
	...
	public void testRemoveEntryByTelExt() {
		ListDirectory directory; //ArrayDirectory object that will be used for the tests
		Long timeElapsed; //Stores an individual timing from Stopwatch.getElapsedTime()
		List<Long> timings = new ArrayList<Long>(); //Used to store multiple timings so they can be compared
		Long avarage; // Stores the returned average time from getAvarageTime()
		Long best; // Stores the returned best time from getBestTime()
		...
		directory = new ListDirectory(); //Instantiates the ArrayDirectory
		Scanner inFile;
		try {
			inFile = new Scanner(new FileReader("names.txt"));
		...
		System.out.format("Timings for ListDirectory removeEntry using telExt to search method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testRemoveEntryByName() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ListDirectory removeEntry using name to search method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testChangeNumber() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ListDirectory changeNumber method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public void testLookupTelExtNum() {
		...
		// Print the average, best and worst timings
		System.out.format("Timings for ListDirectory lookupExtNum method:\nAvarage: %d\nBest: %d\nWorst: %d", avarage, best, worst);
		} catch (FileNotFoundException e) {
			System.out.println("Error! File not found. Please ensure that an appropriate text file is available");
			e.printStackTrace();
		}
	...
	public static void main(String[] args) {
		new ListDirectoryStopWatchTest();
	}
